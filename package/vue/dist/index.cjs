...
var import_vue453 = require("vue"), import_vue454 = require("vue"), custom_icon_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue453.defineComponent)({
  __name: "custom-icon",
  props: {
    width: {
      type: String || Number,
