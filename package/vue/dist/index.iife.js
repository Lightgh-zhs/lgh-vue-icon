...
var LghVue = (() => {
  ...
  var import_vue453 = __toESM(require_vue()), import_vue454 = __toESM(require_vue()), custom_icon_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue453.defineComponent)({
    __name: "custom-icon",
    props: {
      width: {
        type: String || Number,
    ...
    setup(__props) {
      let props = __props;
      return (_ctx, _cache) => ((0, import_vue454.openBlock)(), (0, import_vue454.createElementBlock)(
        "i",
        {
          class: "l-icon",
          style: (0, import_vue454.normalizeStyle)({ width: __props.width.toString().replace(/px/gi, "").toString + "px", height: __props.height.toString().replace(/px/gi, "").toString + "", color: __props.color })
        },
        [
          ((0, import_vue454.openBlock)(), (0, import_vue454.createBlock)((0, import_vue454.resolveDynamicComponent)(__props.icon)))
        ],
        4
        /* STYLE */
      ));
